...
| # | タイトル | ファイル | 状態 |
|---|---|---|---|
| 1 | ベクトルとベクトル空間 | `phase1_linear_algebra/01_vectors/00_index.md` | [ ] |
...
| 7 | 線形変換の幾何学（回転・射影・基底変換） | `phase1_linear_algebra/07_linear_transform_geometry.md` | [ ] |
| 8 | まとめと演習（PCA・注意機構への接続） | `phase1_linear_algebra/08_review.md` | [ ] |
...
| 4 | テイラー展開と近似 | `phase2_calculus/04_taylor_expansion.md` | [ ] |
| 5 | 勾配・ヤコビアン・ヘッシアン | `phase2_calculus/05_gradient_jacobian_hessian.md` | [ ] |
| 6 | 連鎖律とバックプロパゲーション | `phase2_calculus/06_chain_rule_backprop.md` | [ ] |
| 7 | 最適化（勾配降下法・収束性） | `phase2_calculus/07_optimization.md` | [ ] |

## Phase 3 — 確率・情報理論

| # | タイトル | ファイル | 状態 |
|---|---|---|---|
| 1 | 確率の基礎（測度論的視点を含む） | `phase3_probability/01_probability_basics.md` | [ ] |
...
| 7 | 言語モデルと確率（ソフトマックス・トークン予測） | `phase3_probability/07_language_model.md` | [ ] |
...
| 8 | 圏論と機械学習（関手としてのニューラルネット） | `phase5_category_theory/08_category_and_ml.md` | [ ] |
| 9 | まとめと応用 | `phase5_category_theory/09_review.md` | [ ] |
